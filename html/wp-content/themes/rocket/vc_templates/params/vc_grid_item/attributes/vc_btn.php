...
if ( 'true' === $add_icon ) {
	$button_class .= ' btn-has-icon icon-' . $i_align;
	...
	if ( $icon_wrapper ) {
		$icon_html = '<i class="btn-icon"><span class="vc_btn3-icon-inner ' . esc_attr( $iconClass ) . '"></span></i>';
	} else {
		$icon_html = '<i class="btn-icon ' . esc_attr( $iconClass ) . '"></i>';
	}
