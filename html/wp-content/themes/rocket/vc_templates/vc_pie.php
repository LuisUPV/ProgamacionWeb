...
$colors = array(
	'primary1'   => $rocket_data['rocket__opt_primary_color'],
	'secondary'  => $rocket_data['rocket__opt_secondary_color'],
	'tertiary'   => $rocket_data['rocket__opt_tertiary_color'],
	'quaternary' => $rocket_data['rocket__opt_quaternary_color'],
	'black'      => '#2a2a2a',
	'grey'       => '#ebebeb',
	'white'      => '#ffffff',
);
