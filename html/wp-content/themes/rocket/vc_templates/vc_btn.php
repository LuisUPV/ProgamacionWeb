 ...
 * @var $custom_text
 * @var $custom_background_hover
 * @var $custom_text_hover
 * @var $size
 * @var $align
 * @var $link
 * @var $title
 ...
 */
$style = $shape = $color = $size = $custom_background = $custom_text = $custom_background_hover = $custom_text_hover = $align = $link = $title = $button_block = $el_class = $outline_custom_color = $outline_custom_hover_background =
...
if ( 'true' === $add_icon ) {
	$button_classes[] = 'btn-has-icon icon-' . $i_align;
	...
	if ( $icon_wrapper ) {
		$icon_html = '<i class="btn-icon"><span class="btn-icon-inner ' . esc_attr( $icon_class ) . '"></span></i>';
	} else {
...
if ( 'custom' === $style ) {
	...
	if ( $custom_background_hover ) {
		$attributes[] = 'onmouseenter="this.style.backgroundColor=\'' . $custom_background_hover . '\'; this.style.color=\'' . $custom_text_hover . '\' "';
		$attributes[] = 'onmouseleave="this.style.backgroundColor=\'' . $custom_background . '\'; this.style.color=\'' . $custom_text . '\' "';
	}
