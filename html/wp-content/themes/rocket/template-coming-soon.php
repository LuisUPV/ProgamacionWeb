...
$date  = $rocket_data['rocket__opt-coming-datepicker'];
$days  = $rocket_data['rocket__opt-coming-days-txt'];
$hours = $rocket_data['rocket__opt-coming-hours-txt'];
$mins  = $rocket_data['rocket__opt-coming-mins-txt'];
$secs  = $rocket_data['rocket__opt-coming-secs-txt'];
?>

<div class="container">
	<header class="page-coming-soon-header">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<?php the_title( '<h1>', '</h1>' ); ?>
				<?php if ( $rocket_data['rocket__opt-coming-title-divider'] == 1 ) { ?>
