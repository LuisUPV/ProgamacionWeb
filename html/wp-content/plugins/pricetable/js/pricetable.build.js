...
jQuery(function($){
	...
	resetColumns = function(){
		...
		$('.price-columns .column').each(function(i, el){
			...
			$$.find('.column-discount').attr('name', 'price_'+i+'_discount');
			$$.find('.column-img').attr('name', 'price_'+i+'_img');
			$$.find('.column-status').attr('name', 'price_'+i+'_status');
	...
	var addPriceCol = function(){
		...
		$('.column-discount',column).attr('name', 'price_'+thisICol+'_discount').val('');
		$('.column-img',column).attr('name', 'price_'+thisICol+'_img').val('');
		$('.column-status',column).attr('name', 'price_'+thisICol+'_status').val('');
